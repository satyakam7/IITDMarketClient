...
export const postItem = (data) => dispatch => {
    ...
    axios.post('/item', qs.stringify(data))
        .then(res => {
...
export const editItem = (data, id) => dispatch => {
    ...
    axios.put('/item/'+ id, qs.stringify(data))
        .then(res => {
...
export const selliniItem = (id, data) => dispatch => {
    ...
    axios.patch('/item/'+ id + '/sellIni', qs.stringify(data)) 
        .then(res => {
...
export const sellfniItem = (id, data) => dispatch => {
    ...
    axios.patch('/item/'+ id + '/sellFin', qs.stringify(data)) 
        .then(res => {
