        ...
        <IonPage>
            ...
            <IonContent>
                ...
                <IonGrid className="grid">
                    ...
                    <IonRow>
                        <IonCol className="colgap">
                            <IonButton> Get on PlayStore</IonButton>
                        </IonCol>
                        <IonCol className="colgap">
                            <IonButton> Get on AppStore</IonButton>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        <IonCol className="colgap">
                            <IonButton> Contact For Help</IonButton>
                        </IonCol>
                    </IonRow>
                </IonGrid>
            </IonContent>
